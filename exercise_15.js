...
// In addition to the callback function, reduce has an additional parameter which takes an initial value for the accumulator. If this second parameter is not used, 
...
// Initialize the sum of 0
// let sum = 0

// Loop/iterate through each user in the array
// for (let i = 0; i < users.length; i++) {

//     add the age of the current user to the sum
//     sum = sum + users[i].age;
// }
